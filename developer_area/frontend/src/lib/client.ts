...
export const Local: BaseURL = 'http://localhost:4001'
...
export namespace user {
  ...
  export class ServiceClient {
    ...
    public async VerifyEmail(params: VerifyEmailParams): Promise<void> {
      ...
      await this.baseClient.callTypedAPI('GET', `/verify_email`, undefined, {
        query,
      })
    }
  }
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === 'undefined') {
      this.headers['User-Agent'] =
        'goauth-5g62-Generated-TS-Client (Encore/v1.46.4)'
    }
